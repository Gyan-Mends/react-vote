        ...
        <div className="container" class="bg-gray-100 h-[100vh] flex">
            ...
            <div class=" p-4">
                ...
                <div class=" grid grid-cols-2 w-[80vw] h-12 rounded bg-white shadow-md p-2">
                    <div class="l">
                        <p class="text-gray-500">Pages/Results</p>
                    </div>
                    <div class="text-right">
                        <Link to="/elections"> <button class=" text-white rounded border border-2 border-blue-200 bg-blue-400 w-10 text-sm mr-auto">Add </button>
                        </Link>
                    </div>
                </div>
            </div>
